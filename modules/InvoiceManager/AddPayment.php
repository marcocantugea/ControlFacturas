...
if(!empty($_POST)){
    if(isset($_POST['token']) && isset($_POST['idfactura']) && isset($_POST['pagoparcial']) && isset($_POST['fechapago']) ){
        $token=$_POST['token'];
        if($token==$SessionUser->token){
            $pagofactura= new PagoFacturaObj();
            $pagofactura->idfactura=$_POST['idfactura'];
            $pagofactura->pagoparcial=$_POST['pagoparcial'];
            $pagofactura->fechadepago=$_POST['fechapago'];
